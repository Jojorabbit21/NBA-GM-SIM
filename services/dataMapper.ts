...
export const mapRawPlayerToRuntimePlayer = (raw: any): Player => {
    ...
    // [New] Dynamic Calculation of Category Averages
    ...
    const defaultStats = { 
        ...
        // Detailed Zone Stats Initialization
    ...
    const player: Player = {
        ...
        // Override the raw category values with calculated ones
        ins: calculatedIns,
        out: calculatedOut,
        plm: calculatedPlm,
        def: calculatedDef,
    ...
    // 생성 FA 선수: 직전 계약 연봉 / 재직 기간 (Bird Rights 계산 및 UI 표시용)
