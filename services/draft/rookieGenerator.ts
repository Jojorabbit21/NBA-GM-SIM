...
// [2026-09-22] 표/계산 본체는 services/contracts/rookieScaleTable.ts(순수 모듈, 서버 안전)로 이동 —
// 이 파일은 LEAGUE_FINANCIALS 부작용 체인 때문에 서버 finalize에서 import할 수 없어서.
// 기존 호출부 호환을 위해 같은 이름으로 re-export 한다.
export {
    ROOKIE_SCALE_PICK_PCT, ROOKIE_SCALE_Y2_MULT, ROOKIE_SCALE_Y3_MULT,
    estimateFourthYearRaisePct, calcRookieScaleYears,
} from '../contracts/rookieScaleTable';
import { calcRookieScaleYears } from '../contracts/rookieScaleTable';
