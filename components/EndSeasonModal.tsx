        ...
        <div className="p-8 text-center flex flex-col items-center">
            ...
            <div className="flex gap-4 w-full">
                ...
                <button
                    onClick={onReset}
                    disabled={isLoading}
                    className="flex-1 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white font-black uppercase text-xs tracking-widest transition-all shadow-lg shadow-indigo-900/30 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
