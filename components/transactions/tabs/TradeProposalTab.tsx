                                    ...
                                    <div key={idx}>
                                        ...
                                        <div className="px-6 py-3 bg-slate-950/50 flex items-center justify-between sticky top-0 z-10">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded ${req.diffValue >= 0 ? 'text-emerald-400 bg-emerald-400/10' : 'text-slate-500 bg-slate-800'}`}>
                                                    {req.diffValue >= 0 ? '가치 이득' : '가치 균형'}
                                                </span>
                                            </div>
                                            <button
