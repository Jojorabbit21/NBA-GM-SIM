        ...
        <div className={slidersOnly ? undefined : "grid grid-cols-1 lg:grid-cols-12 gap-8"}>
            ...
            <div className={slidersOnly ? "flex flex-col gap-1" : "lg:col-span-5 lg:pl-2 flex flex-col gap-1"}>
                ...
                <SliderGroupNotes notes={[
                    ...
                    { label: '수비 압박 강도', text: '타이트할수록 스틸 시도가 늘어나지만, 파울 트러블 위험이 커집니다.' },
                    { label: '스위치 수비', text: '스크린 대처 방식입니다. 스위치할수록 미스매치 위험이 있지만 오픈 찬스는 줄어듭니다.' },
                    { label: '픽앤롤 수비', text: '드랍: 빅맨이 뒤로 빠져 림 보호(미드레인지 허용). 헷지: 빅맨이 순간 나와 핸들러 지연 후 복귀. 블리츠: 빅맨이 볼 핸들러를 더블팀(턴오버 유발, 킥아웃 3점 허용).' },
                    { label: '풀코트 프레스', text: '체력을 급격히 소모하며 턴오버를 유발합니다. 가드 스태미나/스피드가 높을 때만 효과적.' },
                    { label: '헬프 수비', text: '적극 지원할수록 페인트존 보호가 강해지지만, 외곽 3점슛을 허용할 위험이 커집니다.' },
