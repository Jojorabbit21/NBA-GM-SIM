...
import { Mail, RefreshCw, CheckCircle2, Filter, Check, Search } from 'lucide-react';
...
export const MessageList: React.FC<MessageListProps> = ({
    ...
    return (
        <div className="w-[280px] flex flex-col border-r border-slate-800 bg-slate-950/30 flex-shrink-0">
            ...
            <div className="px-3 py-2.5 border-b border-slate-800 bg-slate-950 flex items-center gap-2">
                <div className="flex-1 flex items-center gap-2 bg-slate-900 border border-slate-700/60 rounded-lg px-2.5 py-1.5">
