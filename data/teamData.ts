...
// ── Team Colors (Figma Colors.tokens.json 기준) ──
export const TEAM_COLORS: Record<string, { primary: string; secondary: string; tertiary?: string; text: string }> = {
    ...
    'ind': { primary: '#FDBB30', secondary: '#002D62', tertiary: '#BEC0C2', text: '#002D62' },
    'law': { primary: '#003DA5', secondary: '#D50032', tertiary: '#000000', text: '#FFFFFF' },
    'lam': { primary: '#FDB927', secondary: '#31006F', tertiary: '#010101', text: '#31006F' },
    ...
    'no':  { primary: '#E31837', secondary: '#B4975A', tertiary: '#002B5C', text: '#FFFFFF' },
    ...
    'phx': { primary: '#E56020', secondary: '#1D1160', tertiary: '#F9A01B', text: '#FFFFFF' },
    ...
    'sa':  { primary: '#C4CED4', secondary: '#010101', tertiary: '#272727', text: '#010101' },
