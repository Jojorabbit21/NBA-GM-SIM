...
export const TEAM_COLORS: Record<string, { primary: string; secondary: string; text: string }> = {
    ...
    'la2': { primary: '#C8102E', secondary: '#0C2340', text: '#FFFFFF' },
    'la1': { primary: '#552583', secondary: '#FDB927', text: '#FFC72C' },
...
export let TEAM_DATA: Record<string, TeamStaticData> = {
    ...
    'la2': { id: 'la2', city: 'LA', name: '와일드캣', conference: 'West', division: 'Pacific', owner: '스티븐 B.', colors: TEAM_COLORS['la2'] },
    'la1': { id: 'la1', city: 'LA', name: '레전드', conference: 'West', division: 'Pacific', owner: '지나 B.', colors: TEAM_COLORS['la1'] },
