...
import { PossessionResult, LivePlayer, CourtSnapshot, PlayerCourtPosition } from '../pbpTypes.ts';
import { COURT_WIDTH, COURT_HEIGHT, HOOP_X_LEFT, HOOP_Y_CENTER } from '../../../utils/courtCoordinates.ts';
