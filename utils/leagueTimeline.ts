/**
 * ⚠️ 클라이언트 미러 — server/src/shared/leagueTimeline.ts와 import 경로만 다르고 내용은 동일해야
 * 한다. 서버 쪽을 고치면 이 파일도 같은 내용으로 갱신할 것(docs/history/dev-log.md 2026-09-18).
 */
/**
 ...
 */
import { KST_OFFSET_MS } from './kstTime';
